...
-- CreateIndex
CREATE INDEX "Product_specialty_idx" ON "Product"("specialty");

-- CreateIndex
CREATE INDEX "Product_group_idx" ON "Product"("group");

-- CreateIndex
CREATE INDEX "WeeklyPlanning_zone_idx" ON "WeeklyPlanning"("zone");

-- CreateIndex
CREATE INDEX "WeeklyPlanning_month_idx" ON "WeeklyPlanning"("month");

-- CreateIndex
CREATE INDEX "VisitReport_delegateId_idx" ON "VisitReport"("delegateId");
