...
exports.reportSubmittedEmail = reportSubmittedEmail;
exports.alertInactiveDelegateEmail = alertInactiveDelegateEmail;
...
function reportSubmittedEmail(adminName, labName, month, year, totalCA, totalVentes) {
    return `
...
function alertInactiveDelegateEmail(delegateName, zone, lastReportDate, daysSince) {
    return `
    <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#f8fafc;padding:20px;border-radius:12px">
      <div style="background:#0f172a;padding:20px;border-radius:8px;text-align:center;margin-bottom:20px">
        <h1 style="color:white;margin:0;font-size:22px">🏥 INOX PHARMA</h1>
